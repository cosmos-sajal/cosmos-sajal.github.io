<h1><a href="{{ "/" | absolute_url }}"><img style="max-width: 4%" src="/images/back.png"></a><label style="margin-left: 2%"> Articles</label></h1>
...
<a href="https://cosmos-sajal.medium.com/7-deadly-sins-associated-with-your-everyday-products-c1be53421878" target="_blank">
  <div style="border: 1px solid rgba(230, 230, 230, 1)">
  <img src="images/deadly_sins.webp?raw=true" style="height: inherit">
  </div>
  <div style="margin-top: 15px;">
    <h2 style="margin-bottom: 4px">7 Deadly Sins associated with your everyday Products</h2>
